...
const PopulationGradeList: React.FC = () => {
  ...
  return (
    <div className="max-w-full mx-auto mt-10 p-6 parameter-population-layout">
      <Joyride
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
        ...
        <div className="mb-6 flex items-center gap-4 parameter-population-toolbar">
          ...
          <div className="flex gap-4 parameter-population-filters">
            <button
        ...
        <div className="overflow-x-auto bg-white rounded-2xl border border-gray-200 shadow-sm p-4 parameter-population-table">
        ...
        <div className="mt-6 flex items-center justify-between parameter-population-pagination">
