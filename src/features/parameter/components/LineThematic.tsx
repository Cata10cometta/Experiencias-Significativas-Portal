        ...
        <div className="rounded-lg border border-gray-100 p-2 overflow-auto">
          <table className="min-w-full border-collapse w-full table-auto">
            ...
            <tbody>
              {filtered.length === 0 ? (
                <tr>
                  <td colSpan={4} className="py-6 px-4 text-center text-gray-500">No hay líneas temáticas para mostrar.</td>
                </tr>
              ) : (
                paginated.map((lineThematic) => (
                  <tr key={lineThematic.id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="py-2 px-4 border-b flex gap-2">
                      <button className="px-3 py-1 rounded bg-sky-600 text-white hover:bg-sky-700 text-sm" onClick={() => setEditLineThematic(lineThematic)}>Editar</button>
                      {lineThematic.state ? (
                        <button className="px-3 py-1 rounded bg-red-500 hover:bg-red-700 text-white text-sm" onClick={() => handleDeactivate(lineThematic.id)}>Desactivar</button>
                      ) : (
                        <button className="px-3 py-1 rounded bg-green-500 hover:bg-green-700 text-white text-sm" onClick={() => handleActivate(lineThematic.id)}>Activar</button>
                      )}
                    </td>
                  </tr>
                ))
