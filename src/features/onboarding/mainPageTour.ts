// Configuración y pasos del tour Joyride para MainPage
import { Step } from 'react-joyride';

export const mainPageTourSteps: Step[] = [
  {
    target: ".btn-ayuda",
    title: "Ayuda",
  ...
  },
  {
    ...
    content: "Accede a tu cuenta desde aquí.",
  },
];

export const mainPageTourStyles = {
  options: {
    zIndex: 10000,
    arrowColor: '#fff',
    backgroundColor: '#fff',
...
export const mainPageTourLocale = {
  back: 'Atrás',
  close: 'Cerrar',
  last: 'Finalizar',
  next: 'Siguiente',
